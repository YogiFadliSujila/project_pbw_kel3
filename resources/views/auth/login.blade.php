                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        <input 
                            ...
                            name="email" 
                            id="email" 
                            placeholder="Masukan Nomer Telepon Atau Email" 
                            value="{{ old('email') }}"
                    ...
                    <div class="flex justify-start">
                        <a href="{{ route('password.request') }}" class="text-blue-600 hover:text-blue-800 font-medium text-sm">
                            Lupa Password?
                        </a>
                    </div>
                    ...
                    <div class="text-center mt-6">
                        <p class="text-gray-600 text-sm">
                            Belum Punya Akun? <a href="{{ route('register') }}" class="text-blue-700 font-bold hover:underline">Daftar Sekarang</a>
                        </p>
                    </div>
                </form>
            </div>
