        ...
        <div class="flex items-center gap-8">
            ...
            @auth
                <div class="relative">
                    ...
                    <div id="profilePopup" class="hidden absolute right-0 top-14 w-80 bg-white rounded-3xl shadow-xl border border-gray-100 p-6 z-50 transform origin-top-right transition-all duration-200 text-left">
