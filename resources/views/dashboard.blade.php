    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-white border-r border-gray-100 hidden md:flex flex-col flex-shrink-0 z-20">
            ...
            <div class="p-4 border-t border-gray-50 space-y-2">
                <div class="h-px w-full bg-[#E9D5FF] mb-1 shadow-black-50 shadow-lg"></div>
        ...
        <main class="flex-1 overflow-y-auto bg-[#F8F9FE] p-8">
            ...
            <div class="flex justify-between items-center mb-10">
                <h2 class="text-3xl font-bold text-[#1E2B58]">Dashboard Overview</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                    ...
                    <div class="mt-4 flex items-center text-sm">
                        <span class="{{ $userGrowth >= 0 ? 'text-green-500' : 'text-red-500' }} font-bold flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $userGrowth >= 0 ? 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' : 'M13 17h8m0 0V9m0 8l-8-8-4 4-6-6' }}"></path>
                            </svg>
                            {{ abs($userGrowth) }}%
                        </span>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-[#1E2B58] mt-2">{{ number_format($totalProperties) }}</h3>
                        </div>
                    ...
                    <div class="mt-4 flex items-center text-sm">
                        <span class="{{ $propGrowth >= 0 ? 'text-green-500' : 'text-red-500' }} font-bold flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $propGrowth >= 0 ? 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' : 'M13 17h8m0 0V9m0 8l-8-8-4 4-6-6' }}"></path></svg>
                            {{ abs($propGrowth) }}%
                        </span>
                        <span class="text-gray-400 ml-2">from last month</span>
                    </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-[#1E2B58] mt-2">{{ number_format($totalSales) }}</h3>
                        </div>
                    ...
                    <div class="mt-4 flex items-center text-sm">
                        <span class="{{ $salesGrowth >= 0 ? 'text-green-500' : 'text-red-500' }} font-bold flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $salesGrowth >= 0 ? 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' : 'M13 17h8m0 0V9m0 8l-8-8-4 4-6-6' }}"></path></svg>
                            {{ abs($salesGrowth) }}%
                        </span>
                        <span class="text-gray-400 ml-2">from last month</span>
                    </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-[#1E2B58] mt-2">{{ number_format($totalPending) }}</h3>
                        </div>
                    ...
                    <div class="mt-4 flex items-center text-sm">
                        <span class="text-gray-400">Properties waiting approval</span>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-8">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xl font-bold text-[#1E2B58]">Transaction Statistics ({{ date('Y') }})</h3>
                    </div>
    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Transactions',
                    data: realData, // Data Real dimasukkan disini
                    borderColor: '#3B82F6',
