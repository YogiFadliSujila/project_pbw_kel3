            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-[#1E2B58] mt-2">IDR {{ number_format($totalRevenue / 1000000000, 1) }} B</h3>
                        </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex justify-between items-start">
                    <div>
                        ...
                        <div class="mt-4 text-sm text-gray-400">New transactions added</div>
                    </div>
